...
MACRO(ADD_SIP_PYTHON_MODULE MODULE_NAME MODULE_SIP)
    ...
    # for modules that start with underscore, sip gets rid of the extra underscore
    STRING(REGEX REPLACE "_?(.+)" "\\1" _child_part_name "${_child_module_name}")
    
    SET(_message "-DMESSAGE=Generating CPP code for module ${MODULE_NAME}")
    SET(_sip_output_files)
    FOREACH(CONCAT_NUM RANGE 0 ${SIP_CONCAT_PARTS} )
        IF( ${CONCAT_NUM} LESS ${SIP_CONCAT_PARTS} )
            SET(_sip_output_files ${_sip_output_files} ${CMAKE_CURRENT_BINARY_DIR}/${_module_path}/sip_${_child_part_name}part${CONCAT_NUM}.cpp )
    ...
    IF (CMAKE_SYSTEM_NAME STREQUAL Generic)
        ADD_DEFINITIONS( -fpermissive )
        ADD_EXECUTABLE(${_logical_name} ${_sip_output_files} )
    ELSEIF (CYGWIN OR APPLE)
    ...
    IF (WIN32 OR CMAKE_SYSTEM_NAME STREQUAL Generic)
    ...
    INSTALL(TARGETS ${_logical_name} DESTINATION "${ROBOTPY_DEST_SITE_PACKAGES}/${_parent_module_path}")
